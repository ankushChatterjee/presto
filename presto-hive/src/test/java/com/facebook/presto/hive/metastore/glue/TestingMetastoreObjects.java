...
public final class TestingMetastoreObjects
{
    ...
    public static Database.Builder getGlueTestDatabase()
    {
    ...
    public static Table.Builder getGlueTestTable(String dbName)
    {
        return Table.builder()
                ...
                .storageDescriptor(getGlueTestStorageDescriptor().build())
    ...
    public static SerDeInfo.Builder getGlueTestSerdeInfo()
    {
    ...
    public static Partition.Builder getGlueTestPartition(String dbName, String tblName, List<String> values)
    {
